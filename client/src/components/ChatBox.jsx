    ...
    <div className='flex-1 flex flex-col justify-between m-5 md:m-10 xl:mx-30 max-md:mt-14 2xl:pr-40'> 
      ...
      <form 
          ...
          <select value={mode} onChange={(e)=>setMode(e.target.value)}  className='text-sm pl-3 pr-2 outline-none'>
            <option className='dark:bg-pink-900' value="text">Text</option>
            <option className='dark:bg-pink-900'  value="image">Image</option>
          </select>
          <input 
            ...
            required 
          />
          <button disabled={loading || !prompt}>  {/* Fixed disabled */}
