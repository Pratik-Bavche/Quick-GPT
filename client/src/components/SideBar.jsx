...
const SideBar = ({ menuOpen, setMenuOpen }) => {
  ...
  // Refresh user data when SideBar mounts to ensure credits are up-to-date
  useEffect(() => {
    if (token && user) {
      console.log("🔄 SideBar mounted, refreshing user data...");
      fetchUser();
    }
  }, []);
  ...
  return (
    ...
    >
      ...
      <button
        ...
        className="flex justify-center items-center w-full py-2 mt-6 text-white bg-gradient-to-r from-[#A456F7] to-[#3D81F6] text-sm rounded-md cursor-pointer"
      >
      ...
      <div
        ...
        className="flex items-center gap-2 p-3 mt-3 border border-gray-300 dark:border-white/15 rounded-md cursor-pointer hover:scale-103 transition-all"
      >
        <img
      ...
      <div
        ...
        className="flex cursor-pointer items-center justify-between gap-2 p-3 mt-3 border border-gray-300 dark:border-white/15 rounded-md"
      >
